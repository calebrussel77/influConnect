...
import { createWaitingListSubscriptionSchema } from '../modules/waiting-list/schema';
import { createWaitingListSubscriptionHandler } from '../modules/waiting-list/controller';
