...
const WaitingListLayout: FC<MainProps> = ({
  title,
  description,
  children,
  ...rest
  ...
  return (
    <>
      ...
      <Header />
      <main className="mb-auto flex h-full flex-1 flex-col gap-32">
        {children}
      </main>
      <Footer />
    </>
...
const getLayout = (page: React.ReactElement<SeoProps>) => {
  return <WaitingListLayout {...page.props}>{page}</WaitingListLayout>;
};

export { WaitingListLayout, getLayout as getWaitingListLayout };
